...
$own_id= $_GET["own_id"];
	...
	$query 	= "UPDATE owner SET name='$name', company='$company' , income='$income' WHERE own_id = $own_id";
	...
	echo "<p>Record updated:<br> name = $name <br> company = $company <br> income = $income";
